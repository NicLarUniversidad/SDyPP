...
public class Sobel {
    ...
    public Sobel(BufferedImage bufferedImage) {
    ...
    public BufferedImage aplicarFiltro() {
        ...
        BufferedImage imgNueva = new BufferedImage(width+2, height+2, bufferedImage.getType());
        Graphics gImage = imgNueva.getGraphics();
        gImage.drawImage(bufferedImage,1,1,width,height,null);
        width++;
        height++;
